<?php
// filepath: c:\xampp\htdocs\final\admin\orders\add.php
session_start();
if (!isset($_SESSION['user_id']) || !isset($_SESSION['role_as']) || $_SESSION['role_as'] != 1) { // 1 là admin
